...
export function AccountPanel({ onClose, onLoadTrip }) {
  ...
  useEffect(() => { loadTrips(); }, [user.id]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="panel open account-panel">
      ...
      <div className="panel-header">
        ...
        <h2 className="panel-city account-email">{user.email}</h2>
      </div>
