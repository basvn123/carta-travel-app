...
/**
 * "Continue with Google", the same button on the entry gate and the auth
 * modal. Redirect-based OAuth via Supabase: on success the browser leaves for
 * Google and comes back signed in, so there's no onSuccess to handle here,
 * only the error path when the redirect can't even start.
 */
